...
class TestParser(unittest.TestCase):
    def test_converting_to_rpn(self):
        ...
        self.assertEqual(Parser(['1', '*', '(', '2', '-', '3', ')']).convert_to_rpn(), [1, 2, 3, '-', '*'])
        self.assertEqual(Parser(['pow(', '3', ',', '2', ')', '+', '7']).convert_to_rpn(), [[3, ',', 2], 'pow', 7, '+'])
        self.assertEqual(Parser(['pow(', '1', '*', '2', ',', '2', ')']).convert_to_rpn(), [[1, 2, '*', ',', 2], 'pow'])
        self.assertEqual(Parser(['abs(', 'abs(', '-', '3', ')', ')']).convert_to_rpn(), [[[3, '--'], 'abs'], 'abs'])
        self.assertEqual(Parser(['abs(', '(', '(', '(', '5', ')', ')', ')', ')']).convert_to_rpn(), [[5], 'abs'])
        self.assertEqual(Parser(['1', '==', '1', '==', '1', '*', '1']).convert_to_rpn(), [1, 1, '==', 1, 1, '*', '=='])
